...
public class Graph_M
{
    ...
    {
        g.addVertex("New Market~B");
        g.addVertex("MP Nagar~B");
        g.addVertex("Habibganj~B");
        g.addVertex("DB City Mall~BY");
        g.addVertex("Kolar Road~B");
        g.addVertex("Ashoka Garden~B");
        g.addVertex("Hoshangabad Road~BO");
        g.addVertex("Bairagarh~B");
        g.addVertex("AIIMS Bhopal~Y");
        g.addVertex("Indrapuri~Y");
        g.addVertex("Vidyasagar College~Y");
        g.addVertex("Bhopal Junction~Y");
        g.addVertex("BHEL~Y");
        g.addVertex("Govindpura~Y");
        g.addVertex("Arera Hills~O");
        g.addVertex("Barkatullah University~O");
        g.addVertex("Airport~O");
        g.addVertex("Chuna Bhatti~BP");
        g.addVertex("Shahpura~PR");
        g.addVertex("Katara Hills~P");

        g.addEdge("New Market~B", "MP Nagar~B", 8);
        g.addEdge("MP Nagar~B", "Habibganj~B", 10);
        g.addEdge("Habibganj~B", "Kolar Road~B", 8);
        g.addEdge("Habibganj~B", "DB City Mall~BY", 6);
        g.addEdge("DB City Mall~BY", "Ashoka Garden~B", 9);
        g.addEdge("Ashoka Garden~B", "Hoshangabad Road~BO", 7);
        g.addEdge("Hoshangabad Road~BO", "Bairagarh~B", 6);
        g.addEdge("AIIMS Bhopal~Y", "Indrapuri~Y", 15);
        g.addEdge("Indrapuri~Y", "Govindpura~Y", 6);
        g.addEdge("Govindpura~Y", "DB City Mall~BY", 7);
        g.addEdge("DB City Mall~BY", "Bhopal Junction~Y", 1);
        g.addEdge("Bhopal Junction~Y", "BHEL~Y", 2);
        g.addEdge("BHEL~Y", "Vidyasagar College~Y", 5);
        g.addEdge("Bhopal Junction~Y", "Arera Hills~O", 2);
        g.addEdge("Arera Hills~O", "Barkatullah University~O", 7);
        g.addEdge("Barkatullah University~O", "Airport~O", 8);
        g.addEdge("Ashoka Garden~B", "Chuna Bhatti~BP", 2);
        g.addEdge("Katara Hills~P", "Chuna Bhatti~BP", 2);
        g.addEdge("Katara Hills~P", "Shahpura~PR", 5);
